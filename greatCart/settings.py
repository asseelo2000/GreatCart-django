...
SECRET_KEY = 'django-insecure-=^@!c(bymo_0%7y2#6_0lfezf$l2nk05dv)7zhe98)y(^_l$ec'
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'category.context_processors.categories_processor',  # categories context processor
...
EMAIL_PORT = 587
EMAIL_USE_TLS = True
EMAIL_HOST_USER = 'asseeloalazazi4000@gmail.com'
EMAIL_HOST_PASSWORD = 'yrarcwakulekiwfp'
